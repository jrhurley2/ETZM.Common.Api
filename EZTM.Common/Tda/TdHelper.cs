...
namespace EZTM.Common.Tda
{
    public class TdHelper : Brokerage
    {
        ...
        private Dictionary<string, Common.Model.StockQuote> _stockQuotes = new();
        ...
        public override Common.Model.StockQuote SetStockQuote(Common.Model.StockQuote stockQuote)
        {
        ...
        public override Common.Model.StockQuote GetStockQuote(string symbol)
        {
        ...
        private readonly Subject<Common.Model.StockQuote> _stockQuoteRecievedSubject = new Subject<Common.Model.StockQuote>();
        public override IObservable<Common.Model.StockQuote> StockQuoteReceived => _stockQuoteRecievedSubject.AsObservable();

        private readonly Subject<Common.Model.StockQuote> _futureQuoteRecievedSubject = new Subject<Common.Model.StockQuote>();
        public override IObservable<Common.Model.StockQuote> FutureQuoteReceived => _futureQuoteRecievedSubject.AsObservable();
